            ...
            <form onSubmit={e => handleSubmit(e)}>
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        ...
                        <Select native displayEmpty={true} value={formData['dietState']} 
                    ...
                    <Grid item xs={12}>
                        ...
                        <Select native displayEmpty={true} value={formData['cuisineState']} 
                    ...
                    <Grid item xs={12}>
                        ...
                        <Select native displayEmpty={true} value={formData['intoleranceState']} 
                    ...
                    <Grid item xs={12}>
                        ...
                        <Select native displayEmpty={true} value={formData['typeState']} 
                    ...
                    <Grid item xs={3}>
                        ...
                        <TextField type="number" value={formData['minVal']} onChange={e => handleChange('minVal', e.target.value)}/>
                    </Grid>
                    <Grid item xs={3}>
                        <InputLabel color="primary">Max Calories</InputLabel>
                        <TextField type="number" value={formData['maxVal']} onChange={e => handleChange('maxVal', e.target.value)}/>
                    </Grid>
                    <Grid item xs={12}>
